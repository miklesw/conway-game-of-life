...
public class GridUtilsTest {
    ...
    public void givenACellSurroundedByCells_whenFindingNeighbouringCells_then8NeighboursWillBeReturned() {
        // when
        Set<CellPosition> neighbouringCells = GridUtils.determineNeighbouringCells(new CellPosition(3, 3), 6, 6);
    ...
    public void givenACellAtGridEdge_whenFindingNeighbouringCells_then6NeighboursWillBeReturned() {
        // when
        Set<CellPosition> rightEdgeCell = GridUtils.determineNeighbouringCells(new CellPosition(6, 3), 6, 6);
        ...
        Set<CellPosition> leftEdgeCell = GridUtils.determineNeighbouringCells(new CellPosition(1, 3), 6, 6);
        ...
        Set<CellPosition> topEdgeCell = GridUtils.determineNeighbouringCells(new CellPosition(3, 1), 6, 6);
        ...
        Set<CellPosition> bottomEdgeCell = GridUtils.determineNeighbouringCells(new CellPosition(3, 6), 6, 6);
    ...
    public void givenACellAtGridCorner_whenFindingNeighbouringCells_then3NeighboursWillBeReturned() {
        Set<CellPosition> topLeftCornerCell = GridUtils.determineNeighbouringCells(new CellPosition(1, 1), 6, 6);
        ...
        Set<CellPosition> bottomRightCornerCell = GridUtils.determineNeighbouringCells(new CellPosition(6, 6), 6, 6);
        ...
        Set<CellPosition> topRightCornerCell = GridUtils.determineNeighbouringCells(new CellPosition(6, 1), 6, 6);
        ...
        Set<CellPosition> bottomLeftCornerCell = GridUtils.determineNeighbouringCells(new CellPosition(1, 6), 6, 6);
